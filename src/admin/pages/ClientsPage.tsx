    ...
    <div style={{ padding: 32 }}>
      <div style={{ background: '#121216', border: '1px solid #24242A', borderRadius: 12, padding: 32, maxWidth: 540 }}>
        ...
        <p style={{ color: '#8B8B94', fontSize: 14, lineHeight: 1.6, margin: 0 }}>
          Les données clients finaux appartiennent au tenant privé de chaque atelier. La console d'administration SaaS ne permet pas d'accéder au carnet de clients des ateliers.
        </p>
      </div>
    </div>
  );
